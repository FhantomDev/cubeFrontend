...
export const especialidad = {
  0: {
    ...
    columnDefs: [
      { headerName: "Especialidad", field: "detalle_factura.grupo_cliente", valueGetter: p => p.data ? p.data["detalle_factura.grupo_cliente"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
