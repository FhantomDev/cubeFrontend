...
export const gerencia = {
  0: {
    ...
    columnDefs: [
      { headerName: "Gerencia", field: "detalle_factura.zona_ventas", valueGetter: p => p.data ? p.data["detalle_factura.zona_ventas"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 200, pinned: 'left' },
