...
export const jefe_categoria = {
  0: {
    ...
    columnDefs: [
      { headerName: "Jefe Categoria", field: "detalle_factura.jefe_categoria", valueGetter: p => p.data ? p.data["detalle_factura.jefe_categoria"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
