...
export const origen = {
  0: {
    ...
    columnDefs: [
      { headerName: "Orígen", field: "detalle_factura.origen_pedido", valueGetter: p => p.data ? p.data["detalle_factura.origen_pedido"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 200, pinned: 'left' },
