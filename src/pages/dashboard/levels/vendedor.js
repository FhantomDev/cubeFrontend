...
export const vendedor = {
  0: {
    ...
    columnDefs: [
      { headerName: "Vendedor", field: "detalle_factura.vendedor", valueGetter: p => p.data ? p.data["detalle_factura.vendedor"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 200, pinned: 'left' },
