...
export const numero_factura = {
  0: {
    ...
    columnDefs: [
      { headerName: "Factura", field: "detalle_factura.numero_factura_view", valueGetter: p => p.data ? p.data["detalle_factura.numero_factura_view"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 270 },
      ...
      { headerName: "Precio Unit.", field: "detalle_factura.precio_unitario", valueGetter: p => p.data ? Number(p.data["detalle_factura.precio_unitario"]) : 0, aggFunc: 'sum', enableValue: true, valueFormatter: p => currencyFormatter.format(p.value), filter: 'agNumberColumnFilter' },
      ...
      { headerName: "Margen Unit.", field: "detalle_factura.margen_unitario", valueGetter: p => p.data ? Number(p.data["detalle_factura.margen_unitario"]) : 0, aggFunc: 'sum', enableValue: true, valueFormatter: p => currencyFormatter.format(p.value), filter: 'agNumberColumnFilter' },
