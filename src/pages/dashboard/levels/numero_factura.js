...
export const numero_factura = {
  0: {
    ...
    columnDefs: [
      { headerName: "Factura", field: "detalle_factura.numero_factura_view", valueGetter: p => p.data ? p.data["detalle_factura.numero_factura_view"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
