...
export const um_venta = {
  0: {
    ...
    columnDefs: [
      { headerName: "Unidad Medida Venta", field: "detalle_factura.um_venta", valueGetter: p => p.data ? p.data["detalle_factura.um_venta"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 200, pinned: 'left' },
