...
export const marca = {
  0: {
    ...
    columnDefs: [
      { headerName: "Marca", field: "detalle_factura.marca", valueGetter: p => p.data ? p.data["detalle_factura.marca"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
