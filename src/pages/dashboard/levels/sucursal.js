...
export const sucursal = {
  0: {
    ...
    columnDefs: [
      { headerName: "Sucursal", field: "detalle_factura.oficina_ventas", valueGetter: p => p.data ? p.data["detalle_factura.oficina_ventas"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
