...
export const canal = {
  0: {
    ...
    columnDefs: [
      { headerName: "Canal", field: "detalle_factura.canal", valueGetter: p => p.data ? p.data["detalle_factura.canal"] : '', enableRowGroup: true, filter: 'agSetColumnFilter', minWidth: 260, pinned: 'left' },
